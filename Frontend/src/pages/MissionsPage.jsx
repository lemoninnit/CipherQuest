  ...
  return (
    <div className="missions-container">
      <div className="missions-header glass-card">
        ...
        <h2 className="header-title-main">Agent Mission Board</h2>
        <p className="header-desc-main">
          These missions are fetched dynamically in real-time from the cloud-hosted <strong>Supabase</strong> PostgreSQL database instance.
        </p>
      </div>
