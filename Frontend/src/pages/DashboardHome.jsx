    ...
    <>
        ...
        <div className="hero-grid">
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <button className="btn-continue" onClick={() => navigate('/dashboard/fishing')}>
                🎣 Play Fishing Game
              </button>
      ...
      <section className="quick-stats-section">
        <div className="quick-stats-grid">
          <div className="qs-card">
            <span className="material-symbols-outlined qs-icon text-primary">phishing</span>
            <div>
              <div className="qs-num">{user?.fishingGamesPlayed ?? 0}</div>
              <div className="qs-label">Fishing Games</div>
            </div>
          </div>
          <div className="qs-card">
            ...
            <div>
              ...
              <div className="qs-label">Best Fish Score</div>
            </div>
          </div>
          <div className="qs-card">
      ...
      <section className="cipher-section">
        ...
        <div className="cipher-grid">
          {/* Fishing Game Card */}
          <div className="cipher-card border-primary-hover" onClick={() => navigate('/dashboard/fishing')} style={{ cursor: 'pointer' }}>
            <div className="cipher-icon-wrapper bg-primary-light glow-primary-hover">
              <span className="material-symbols-outlined text-primary icon-32">phishing</span>
            </div>
            <h4 className="cipher-title">Cipher Fishing</h4>
            <p className="cipher-desc">Decode Caesar-encrypted words and reel in XP. 10 casts per session.</p>
            <div className="cipher-footer">
              <span className="xp-text">+100 XP/catch</span>
              <button className="play-btn bg-primary text-on-primary" onClick={() => navigate('/dashboard/fishing')}>
