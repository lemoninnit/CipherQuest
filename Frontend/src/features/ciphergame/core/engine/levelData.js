...
const caesarWords = {
  ...
  medium: [
    { plain: 'THE QUICK SHIP SAILED ACROSS THE SEA', hint: 'A long journey over the ocean' },
    { plain: 'SILENT NIGHTS BRING BRIGHT STARS', hint: 'A peaceful evening sky' },
    { plain: 'KNOWLEDGE IS THE KEY TO EVERYTHING', hint: 'Learning unlocks doors' },
    { plain: 'FORTUNE FAVORS THE BOLD AND BRAVE', hint: 'Courage brings success' },
    { plain: 'SECRETS ARE HIDDEN IN THE SHADOWS', hint: 'Things concealed in darkness' },
    { plain: 'MYSTERY SURROUNDS THE ANCIENT RUINS', hint: 'Enigma of old structures' },
    { plain: 'A JOURNEY OF A THOUSAND MILES', hint: 'The start of a long trip' },
    { plain: 'NEVER GIVE UP ON YOUR DREAMS', hint: 'Persistence in aspirations' },
    { plain: 'THE EARLY BIRD CATCHES THE WORM', hint: 'Morning success proverb' },
    { plain: 'STARS SHINE BRIGHTEST IN THE DARK', hint: 'Hope in difficult times' },
  ],
  hard: [
    { plain: 'THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG', hint: 'Classic animal pangram' },
    { plain: 'PACK MY BOX WITH FIVE DOZEN LIQUOR JUGS', hint: 'A sturdy box of drinks pangram' },
    { plain: 'HOW VEXINGLY QUICK DAFT ZEBRAS JUMP', hint: 'Annoying striped animals leaping pangram' },
    { plain: 'SPHINX OF BLACK QUARTZ JUDGE MY VOW', hint: 'A vow to an Egyptian statue pangram' },
    { plain: 'TWO DRIVEN JOCKS HELP FAX MY BIG QUIZ', hint: 'Athletes assisting with a test pangram' },
    { plain: 'THE FIVE BOXING WIZARDS JUMP QUICKLY', hint: 'Magicians sparring pangram' },
    { plain: 'BRIGHT VIXENS JUMP DOZY FOWL QUACK', hint: 'Foxes and ducks pangram' },
    { plain: 'QUICK ZEPHYRS BLOW VEXING DAFT MACAQUES', hint: 'Wind and monkeys pangram' },
    { plain: 'SYMPATHIZING WOULD FIX QUAKER OBJECTIVES', hint: 'Understanding resolves goals pangram' },
    { plain: 'A WIZARDS JOB IS TO VEX CHUMPS QUICKLY', hint: 'A magical profession pangram' },
  ],
};
