...
export default function VigenereSprint({ levelData, tier, onVerifySubmit, onBackToStages, onReplayNewQuestion }) {
        ...
        <div className="fg-recap-overlay" style={{ overflowY: 'auto', padding: '30px 10px', zIndex: 9999 }}>
          <div className="fg-recap-card" style={{ maxWidth: '1100px', width: '95%', padding: '24px 32px' }}>
            ...
            <div className="fg-recap-explanation" style={{ background: 'rgba(255,255,255,0.015)' }}>
              💡 <strong>Vigenère Cipher Decryption:</strong> Each ciphertext letter is shifted backward by the key value.
                ...
                return (
                  <div key={sIdx} style={{ marginTop: 16, background: 'rgba(0,229,255,0.05)', border: '1px solid rgba(0,229,255,0.2)', borderRadius: 12, padding: 12 }}>
                    <div style={{ fontWeight: 700, color: 'var(--neon-cyan)', marginBottom: 8, fontSize: '0.82rem' }}>
                      🔑 Alphabet Value Table — Segment #<span style={{ color: 'var(--neon-green)' }}>{sIdx + 1}</span>
                    </div>
                      ...
                      <table style={{ borderCollapse: 'collapse', textAlign: 'center', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', minWidth: 850 }}>
                        <thead>
                          <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                            <th style={{ padding: '4px 2px', textAlign: 'left', color: 'var(--text-muted)' }}>Letter:</th>
                            {alphabet.map((ch, i) => (
                        ...
                        <tbody>
                          <tr>
                            <th style={{ padding: '4px 2px', textAlign: 'left', color: 'var(--text-muted)' }}>Value:</th>
                            {alphabet.map((ch, i) => (
                              <td key={i} style={{ padding: '4px 2px', color: 'var(--neon-yellow)', background: 'rgba(251, 191, 36, 0.02)' }}>
      ...
      {sprintStep === 'ready' ? (
        <div className="cq-brief-screen">
          <div className="cq-brief-card">
            ...
            <h2 className="cq-brief-title">Vigenère Relay Run</h2>
            ...
            <div className="cq-brief-preview">
              ...
              <div className="cq-brief-preview-row">
                <span className="cq-brief-preview-label">Keyword Clue</span>
                <span className="cq-brief-preview-value" style={{ color: 'var(--neon-yellow)' }}>{levelData.keyClue}</span>
              </div>
              <div className="cq-brief-preview-row">
            ...
            <p className="cq-brief-how-it-works">
              ...
              Switch lanes to pick the correct plaintext letter for the repeating keyword slot!
            </p>
        ...
        <div className="sprint-widescreen">
          <aside className="sprint-sidebar">
            ...
            <div className="sidebar-stats-card" style={{ padding: '12px' }}>
              <div className="stats-header" style={{ fontSize: '0.8rem', marginBottom: '8px' }}>📊 ALPHABET VALUES</div>
              <div style={{ overflowX: 'auto' }}>
                <table style={{ borderCollapse: 'collapse', textAlign: 'center', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.65rem', width: '100%' }}>
                  <tbody>
                    <tr>
                      {alphabet.map((ch, i) => (
                        <td key={ch} style={{ padding: '4px 2px', background: 'rgba(255,255,255,0.02)', borderRight: '1px solid rgba(255,255,255,0.05)' }}>
